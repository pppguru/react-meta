    ...
    function App() {
        ...
        this.after('initialize', function() {
            ...
            var content = $(appTemplate({})),
                topbarPane = content.filter('.topbar-pane'),
                ...
                workspacetimelinePane = content.filter('.workspace-timeline').data(DATA_MENUBAR_NAME, 'workspacetimeline'),
            ...
            resizable(mapPane, 'e', 150, 250, this.onPaneResize.bind(this), this.onResizeCreateLoad.bind(this));
            ...
            WorkspaceTimeline.attachTo(workspacetimelinePane.find('.content'));
            ...
            this.attachReactComponentWithStore(Topbar, {}, topbarPane);
            this.attachReactComponentWithStore(MapContainer, {}, mapPane.find('.content'));
        ...
        this.onToggleTimeline = function(event) {
            ...
            WorkspaceTimeline.attachTo(this.$node.find('.workspace-timeline'));
            this.$node.addClass('workspace-timeline-visible');
        };
        ...
        this.toggleDisplay = function(e, data) {
            var self = this,
                SLIDE_OUT = 'search workspaces map admin',
                POPOVER = 'activity',
        ...
        this.triggerPaneResized = function(openingPane) {
            var PANE_BORDER_WIDTH = 1,
                ...
                mapWidth = this.select('mapSelector')
                    .filter('.visible:not(.collapsed)')
                    .outerWidth(true) || 0,
