...
define([
    ...
    var BUTTONS = 'dashboard search workspaces prospects assistance ideas admin activity logout'.split(' '),
        PANE_AUXILIARY = {
            prospects: { name: 'prospects-full', action: { type: 'full', componentPath: 'map/map' } },
            assistance: { name: 'assistance-full', action: { type: 'full', componentPath: 'clients/clients' } },
            ideas: { name: 'ideas-full', action: { type: 'full', componentPath: 'ideas/ideas' } }
        },
        TOOLTIPS = {
            ...
            prospects: i18n('menubar.icons.prospects.tooltip'),
            assistance: i18n('menubar.icons.assistance.tooltip'),
            ideas: i18n('menubar.icons.ideas.tooltip'),
        ...
        MUTALLY_EXCLUSIVE_SWITCHES = [
            { names: ['dashboard', 'prospects', 'assistance', 'ideas'], options: {} },
            { names: ['dashboard', 'prospects-full', 'assistance-full', 'ideas-full'], options: { allowCollapse: false } },
            { names: ['workspaces', 'search', 'admin', 'prospects', 'assistance', 'ideas'], options: { } }
        ],
    ...
    function Menubar() {
         ...
         * `dashboard`, `search`, `workspaces` (cases), `prospects`, `admin`,
         * `activity`, `logout`.
         *
