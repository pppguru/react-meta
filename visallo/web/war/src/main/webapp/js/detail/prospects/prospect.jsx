define([
    ...
    const PinForProspect = React.createClass({
        render() {
    ...
    const Prospect = React.createClass({
        render() {
            const { props } = this;
            const style = {
                display: 'inline-block',
            ...
            return (
                <div className="prospect-item" {...props}>
                    <PinForProspect text={'A'}/>
                    <p style={style}>One Item of Prospects</p>
                </div>
            );
        }
    })
