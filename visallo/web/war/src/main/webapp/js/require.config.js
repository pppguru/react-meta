    ...
    return {
        ...
        map: {
            '*': {
                ...
                'skylight': 'skylight',
                'skylightstateless': 'skylightstateless',
                'styles': 'skylight-styles',
                'utils/assign': 'skylight-assign',
                'TableauReport': 'TableauReport',
        ...
        paths: {
            ...
            'Survey': '../libs/survey-react/survey.react.min',
            'eventemitter3': '../libs/eventemitter3/umd/eventemitter3.min',
            // 'fbjs': '../libs/fbjs/index',
            // 'point-geometry': '../libs/point-geometry/index',
            'scriptjs': '../libs/scriptjs/dist/script.min',
            'google-map-react': '../libs/google-map-react/dist/GoogleMapReact.min',
            ...
            'prop-types': '../libs/prop-types/prop-types.min',
            'react-skylight': '../libs/react-skylight/lib/index',
            'skylight': '../libs/react-skylight/lib/skylight',
            'skylightstateless': '../libs/react-skylight/lib/skylightstateless',
            'skylight-styles': '../libs/react-skylight/lib/styles',
            'skylight-assign': '../libs/react-skylight/lib/utils/assign',
            'tableau-react' : '../libs/tableau-react/dist/index',
            'TableauReport' : '../libs/tableau-react/dist/TableauReport',
            'tableau-api' : '../libs/tableau-react/dist/tableau-api',
            'tokenizeUrl': '../libs/tableau-react/dist/tokenizeUrl',
            'es6-promise' : '../libs/es6-promise/dist/es6-promise.min',
            // 'url' : '../libs/url/url',
            'shallowequal' : '../libs/shallowequal/index'
        },
        shim: {
            ...
            'react': { exports: 'React' },
            'Survey': { deps: ['react', 'react-dom'], exports: 'Survey'},
            'google-map-react': { deps: ['eventemitter3', 'scriptjs']},
            'jquery-scrollstop': { exports: 'jQuery', deps: ['jquery'] },
            'underscore': { exports: '_' },
            'videojs': { exports: 'videojs' },
            'react-skylight': { deps: ['react', 'react-dom', 'prop-types'], exports: 'SkyLight' },
            'skylight': { deps: ['react', 'prop-types'], exports: 'SkyLight' },
            'tableau-react' : { deps: ['es6-promise'], exports: 'TableauReact' },
        },
        amdWrap: [
