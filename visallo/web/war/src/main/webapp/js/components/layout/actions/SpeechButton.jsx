...
define([
    ...
    let $body = $('body');
    let root = window;
    let appConfig = window.SMARTADMIN_GLOBALS;
    let commands;
    ...
    const SpeechButton = React.createClass({
        ...
        render: function () {
            return (
                <div id='speech-btn' className={this.props.className}>
                    <div>
                        <a title='Voice Command' id='voice-command-btn'><i
                            className='fa fa-microphone'/></a>

                        <div ref='popover' className='popover bottom'>
                            ...
                            <div className='popover-content'>
                                ...
                                <a href='#' className='btn btn-success' id='speech-help-btn'>See Commands</a>
                                <a href='#' className='btn bg-color-purple txt-color-white'
                                   onClick={this._hidePopover}>Close Popup</a>
                            </div>
                        </div>
                    </div>
                </div>
